...
<head>
    <meta charset="utf-8">
    <title>{!! __('messages.google-places') !!}</title>
...
<body>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_PLACES_API_KEY') }}&callback=initMap&libraries=places&v=weekly"
            defer
    ></script>
